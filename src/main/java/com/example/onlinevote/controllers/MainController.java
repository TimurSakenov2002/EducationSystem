...
public class MainController {
    ...
    public MainController(QuizRepository quizRepository, UserService userService, GroupRepository groupRepository, ResultRepository resultRepository, QuestionRepository questionRepository, Statistics statistics, ScoreRepository scoreRepository) {
